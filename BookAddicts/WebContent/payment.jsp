...
<div class="row">
    ...
    <div class="container">
        ...
        <div class="row">
          <div class="col-50">
            ...
            <input type="text" name="firstname" placeholder="shyamal kumar das">
            ...
            <div class="row">
              <div class="col-50">
                ...
                <input type="text"  name="state" placeholder="KOL">
              </div>
              <div class="col-50">
                <label for="zip">Zip</label>
                <input type="text"  name="zip" placeholder="711101">
              </div>
            </div>
          </div>
          ...
          <div class="col-50">
            ...
            <input type="text"  name="cardname" placeholder="shyamal kumar das">
        ...
        <div><center>
        <input type="submit"  value="Continue to checkout" class="btn action_btn">
              </center>
       </div>
        </form>
    </div>
  ...
  <div class="col-25">
    <div class="container">
      ...
      <p>payment to the Amdin Panel <span class="price">$50</span></p>
