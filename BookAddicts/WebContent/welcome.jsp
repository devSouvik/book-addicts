...
<html lang="en">
  <head>
    <title>Welcome Book Addicts</title>
    <meta charset="utf-8">
  ...
  <body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar ftco-navbar-light site-navbar-target" id="ftco-navbar">
	    <div class="container">
	      <a class="navbar-brand" href="index.html">Book Addicts<span>.</span></a>
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav nav ml-auto">
	          ...
	          <li class="nav-item"><a href="Login.jsp" class="nav-link"><span>Login</span></a></li>
	          <li class="nav-item"><a href="Registration.jsp" class="nav-link"><span>Register</span></a></li>
	        </ul>
	      </div> 
	    </div>
	  </nav>
      ...
      <div class="container-fluid px-0">
      	<div class="row d-md-flex no-gutters slider-text align-items-center js-fullheight justify-content-end">
	      	<img class="one-third js-fullheight align-self-end order-md-last img-fluid" src="images3/undraw_book_lover_mkck.svg" alt="">
	        <div class="one-forth d-flex align-items-center ftco-animate js-fullheight">
	        	<div class="text mt-5">
	        		<!--<span class="subheading">Best Seller Book Of The Week</span> -->
		  				<h1>WELCOME</h1>
		  				<p> "Never put off till tomorrow the book you can read today." by Holbrook Jackson </p>
